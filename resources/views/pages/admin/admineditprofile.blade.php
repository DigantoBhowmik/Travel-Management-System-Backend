        ...
        <div class="card-body">
            <div class="account-settings">
                <div class="Admin-profile">
                    ...
                    <h5 class="admin-name"><i class="fas fa-user"></i><b> {{Session::get('admin')}}</b></h5>
                    <h6 class="admin-email"><i class="fas fa-envelope"></i><b>{{Session::get('adminEmail')}}</b></h6>
            ...
            <div class="row gutters">
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control" name="Confirm_Password" value="{{$admin->password}}">
